...
public class Problem29 {
    ...
    // nodeinfo의 길이 최대 10,000
    // [x,y]
    // x,y의 최대값은 100,000
    // 트리 깊이 최대 1,000

    // [[5,3],[11,5],[13,3],[3,5],[6,1],[1,3],[8,6],[7,2],[2,2]]	[[7,4,6,9,1,8,5,2,3],[9,6,5,8,1,4,3,2,7]]
    // nodeinfo의 idx는 노드 번호
    ...
    private static void buildTree(int[][] nodeinfo) {
        ...
        tree.sort((a, b) -> {
            if (a.y == b.y) {
                return Integer.compare(a.x, b.x); // x ASC
            }
            return Integer.compare(b.y, a.y); // y DESC
        });

        for (int i = 1; i < tree.size(); i++) {
            insert(tree.get(0), tree.get(i));
        }
    }
    ...
    static void main(String[] args) {
        ...
        int[][] solution = new Problem29().solution(new int[][]{{5, 3}, {11, 5}, {13, 3}, {3, 5}, {6, 1}, {1, 3}, {8, 6}, {7, 2}, {2, 2}});
