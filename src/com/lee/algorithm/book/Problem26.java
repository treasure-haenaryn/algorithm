...
public class Problem26 {
    ...
    static void main(String[] args) {
        ...
        System.out.println(p.solutionV2(8, 4, 7));
    }

    public int order(int[] arrays, int a, int b, int count) {
        count++;
        int[] matches = new int[arrays.length / 2];
        ...
        return order(matches, a, b, count);
    }

    public int solution(int n, int a, int b) {
        int[] arrays = IntStream.rangeClosed(1, n).toArray();
        return order(arrays, a, b, 0);
    }
